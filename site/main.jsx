...
const symbolTypesOperation = [
  ...
  {type: "operation", keyboard: "r", availableFrom: 3, subtype: "RESET", value: "*", svg: Svgs.Relatch},
  {type: "operation", keyboard: "t", availableFrom: 3, subtype: "LOCK/FREE", options: {t: ["LOCK/FREE", Svgs.ToggleLatch], l: ["LOCK", Svgs.Latch], u: ["FREE", Svgs.Unlatch]}},
...
export function DynamicComponent(json, key=0) {
  if (!json) return null;
